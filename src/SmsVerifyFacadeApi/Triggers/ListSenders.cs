...
using IgniteSpotlight.SmsVerifyFacadeApi.Examples;
...
namespace IgniteSpotlight.SmsVerifyFacadeApi.Triggers
{
    /// <summary>
    ...
    public class ListSenders
    {
            ...
            [HttpTrigger(AuthorizationLevel.Function, "GET", Route = "senders")] HttpRequest req)
        {
            ...
            var payload = await result.Content.ReadAsAsync<ListSendersResponse>().ConfigureAwait(false);
